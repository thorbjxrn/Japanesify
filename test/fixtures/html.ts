...
`<div>
    <p>
        ...
        Maxime voluptatibus reprehenderit repellat ad id ex, iure aut culpa error.
        Amet reiciendis suscipit eum dolor facilis repellendus dolores aliquid
        omnis doloremque!
    </p>
</div>
<script>[].push('text with an n');</script>
<style>.mw-editfont-monospace{font-family:monospace,monospace}</style>
